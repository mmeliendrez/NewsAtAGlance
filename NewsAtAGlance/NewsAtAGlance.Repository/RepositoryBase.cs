...
{
    public class RepositoryBase<C>: IDisposable     // C represents the type of the DbContext to use
        where C : DbContext, new()  // Where C inherits from DbContext and has a default constructor
    {
        ...
        //    {
        //        DataContext.Set<T>().Attach(entity);
        //        opStatus.Status = DataContext.re() > 0;
        //    }
        //    catch (Exception exp)
        //    {
